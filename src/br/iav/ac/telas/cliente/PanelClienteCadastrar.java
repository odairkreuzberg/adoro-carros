...
public class PanelClienteCadastrar extends javax.swing.JPanel {
	...
	public PanelClienteCadastrar(JPanel p) {
		super();
		initGUI();
		pTela = p;
	}
	...
	private void initGUI() {
		try {
			...
			JOptionPane.showMessageDialog(this, "Erro ao iniciar tela 'Cadastrar Cliente'.");
		}
	}
	...
	class Mouse extends MouseAdapter {
		...
		public void mouseClicked(MouseEvent e) {
			if (e.getSource() == btnVoltar) {
				PanelClienteCadastrar.this.removeAll();
				PanelClienteCadastrar.this.add(new PanelClientePrincipal(pTela));
				PanelClienteCadastrar.this.repaint();
			}
		}
	}
